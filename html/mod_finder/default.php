...
$output = '<div class="form-group"><input type="text" name="q" id="mod-finder-searchword" class="search-query form-control" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" /></div>';
...
{
	$button = '<button class="btn btn-default finder" type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '"><span class="fa fa-search"></span></button>';
...
<form id="mod-finder-searchform" class="<?php echo $suffix; ?>" action="<?php echo JRoute::_($route); ?>" method="get" class="form-search" role="search">
		<?php
