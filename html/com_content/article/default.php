...
<div class="item-page<?php echo $this->pageclass_sfx; ?>" itemscope itemtype="http://schema.org/Article">
	...
	<?php if ($params->get('access-view')):?>
		...
		<div class="pull-<?php echo htmlspecialchars($imgfloat); ?> item-image" style="height: 300px; margin-bottom: 15px;background: url('<?php echo htmlspecialchars($images->image_fulltext); ?>') no-repeat scroll transparent center center / cover;"></div>
		<?php endif; ?>
